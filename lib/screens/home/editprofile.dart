  ...
  Future <bool> willPopBack() async {
    return showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          title: Text('Unsaved Changes', style: TextStyle(  fontSize: 20, fontWeight: FontWeight.w600, fontFamily: 'SFUIDisplay')),
          content: Text('All unsaved changes will be lost. Are you sure you want to leave? ', style: TextStyle(  fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'SFUIDisplay')),
          actions: <Widget>[
            FlatButton(
