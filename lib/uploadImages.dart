    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: <Widget>[
            ViewImages(),
            UploadImage(globalKey: _globalKey, globalkey: _globalKey),
          ],
        ),
      ),
    );
...
class UploadImage extends StatefulWidget {
  ...
  final GlobalKey<ScaffoldState> globalkey;
  const UploadImage({ this.globalKey,this.globalkey});
  @override
  _UploadImageState createState() => new _UploadImageState();
}

class _UploadImageState extends State<UploadImages> {
